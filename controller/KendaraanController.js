...
exports.create = (kendaraan, pengujian) =>
  new Promise(async (resolve, reject) => {
    await Kendaraan.create(kendaraan)
      .then(async () => {
        await Pengujian.create(pengujian)
...
exports.numpangUji = (data) =>
  new Promise((resolve, reject) => {
    ...
    transaksi.create(data.transaksi).then(() => {
      Kendaraan.findOne({
        nomorUji: data.kendaraan.nomorUji,
      })
        .then((res) => {
          if (res === null) {
            Kendaraan.create(data.kendaraan).then(() => {
